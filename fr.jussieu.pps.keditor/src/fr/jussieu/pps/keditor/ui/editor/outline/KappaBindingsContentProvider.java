...
public class KappaBindingsContentProvider implements ITreeContentProvider {

	/** Returns the children bindings of the given binding. */
	public Object[] getChildren (Object element) {
		return ((KappaBinding)element).getChildren();
	}

	/** Returns the parent binding of the given binding. */
	public Object getParent (Object element) {
		return ((KappaBinding)element).getParent();
	}

	/** Returns whether the given binding has any children. */
	public boolean hasChildren (Object element) {
		return ((KappaBinding)element).hasChildren();
	}
	...
	public Object[] getElements (Object inputElement) {
		return ((KappaProgram)inputElement).getBindings();
	}
