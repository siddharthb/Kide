...
import fr.jussieu.pps.kappa.core.scan.KappaCodeReader;
...
public class KappaBracketMatcher implements ICharacterPairMatcher {
	...
	private IRegion matchForward (IDocument document, int offset, char open, char close) {
		KappaCodeReader reader = new KappaCodeReader(document, offset);
