...
import fr.jussieu.pps.keditor.views.KappaBinariesView.TreeObject1;
 public class binPropertyPage extends PropertyPage implements
          ...
          protected Control createContents(Composite parent) {
                       ...
                       mylabel.setText("Compilation of these:");
                       textField = new Text(myComposite, SWT.MULTI);
          ...
          protected String getAuthor() {
                       IResource resource =
                          ((TreeObject1) getElement()).getResouce();
                       try {
                          String value =
