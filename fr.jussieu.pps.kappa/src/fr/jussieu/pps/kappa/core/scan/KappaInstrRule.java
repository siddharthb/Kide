...
public class KappaInstrRule implements IRule {
	private String[] punct = {"%agent:", "%init:","%var:", "%plot:", "%mod:", "%ref:", "%obs:"};
	private IToken token;
	public KappaInstrRule (IToken successToken) {token = successToken;}
